...
d_model, e_layers, d_layers, d_ff = 50, 2, 2, 2048
...
#print(N_fore)
fore_savepath = 'informer_eicu_full_3hours.pytorch'
...
N_fore = len(fore_train_op)
#print(N_fore)
fore_savepath = 'informer_eicu_restricted_3hours.pytorch'
loss_func = torch.nn.MSELoss(reduction="none")
...
# # Ab hier nichts implementiert

# ## Load target dataset into matrices.

# 
# with open('log_file_train_ip', 'w') as fp:
#     for item in train_ip:
#         # write each item on a new line
#         fp.write("%s\n" % item)
#  
# with open('log_file_test_ip', 'w') as fp:
#     for item in test_ip:
#         for i in item:
#             fp.write("%s " % i)
#         
# with open('log_file_valid_ip', 'w') as fp:
