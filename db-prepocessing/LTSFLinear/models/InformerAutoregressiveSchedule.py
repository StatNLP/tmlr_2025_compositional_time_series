...
class Model(nn.Module):
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec,
                enc_self_mask=None, dec_self_mask=None, dec_enc_mask=None, trainn=False, tgt=torch.zeros(32, 1, 129).cuda(), backprop=False, mode="Forecasting", schedule=True, probability=0.5, deterministic=False):
        #probability of TF. High probability: lots of TF
